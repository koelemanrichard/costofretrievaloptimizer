...
export const AuthorityWizardContainer: React.FC<AuthorityWizardContainerProps> = ({
  ...
  const inventoryWithSemanticData = useMemo(() => {
    if (!batchSemanticAnalysis.results || batchSemanticAnalysis.results.length === 0) return inventory;
    const resultMap = new Map(
      batchSemanticAnalysis.results
  ...
  }, [inventory, batchSemanticAnalysis.results]);
