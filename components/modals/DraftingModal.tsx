        ...
        <footer className="p-2 bg-gray-800 border-t border-gray-700 flex-shrink-0">
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center gap-1">
              ...
              <Button onClick={() => onAnalyzeFlow(draftContent)} variant="secondary" disabled={isLoading || !draftContent || activeTab === 'preview' || enhancement.isPolishing} className="text-xs py-1 px-2 bg-teal-600/20 !text-teal-400 hover:bg-teal-600/40 hover:!text-teal-300 border border-teal-500/30" title="Analyze contextual flow">Flow</Button>
