 ...
 * HelpModal Component
 *
 * Application guide and documentation modal with accordion sections.
    ...
    return (
        <div className="border-b border-gray-700">
            <button
                ...
                className="w-full flex justify-between items-center text-left py-4 px-2 hover:bg-gray-700/50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-inset"
            ...
            <div
                ...
                className={`transition-all duration-300 ease-in-out overflow-hidden ${isOpen ? 'max-h-[1000vh] ease-in' : 'max-h-0 ease-out'}`}
                hidden={!isOpen}
            >
...
const HelpModal: React.FC<HelpModalProps> = ({ isOpen, onClose }) => {
  return (
    <Modal
      isOpen={isOpen}
      onClose={onClose}
      title="Application Guide & Documentation"
      description="Learn how to use the Holistic SEO Topical Map Generator"
      maxWidth="max-w-4xl"
      footer={<Button onClick={onClose} variant="secondary">Close</Button>}
    >
        
        <div className="p-2 sm:p-6 overflow-y-auto">
            <AccordionItem id="getting-started" title="User Guide: Getting Started">
            ...
            <AccordionItem id="new-map-wizard" title="User Guide: The 'New Map' Wizard">
            ...
            <AccordionItem id="dashboard" title="User Guide: The Topical Map Dashboard">
             ...
             <AccordionItem id="methodologies" title="Expert Guide: Methodologies & Calculations">
...
2. The 'predicate' should be one of: IS_A, HAS_PROPERTY, HAS_PART...`}
            ...
            <AccordionItem id="architecture" title="Developer's Guide: Architecture & File Breakdown">
